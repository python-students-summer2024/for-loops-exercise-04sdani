...
def calculate_infections(starting_number_infections, reproduction_rate, num_days):
    ...
    """
    infected_individuals = starting_number_infections * reproduction_rate
    for i in range(num_days-1):
        infected_individuals = infected_individuals * reproduction_rate 
    return int(format(infected_individuals, '.0f'))
